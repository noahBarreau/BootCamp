...
*------------------------------------------------------------
    ...
    CLIQUÉ SUR FINIR LE TOUR, si il clique sur relancer les des, son score depassera 21 et il aura perdu

     -- Info : lorsque la PARTIE est TERMINÉ, le dernier joueur peut continuer a lancer les dés
